  ...
  return (
    <Container user={user} title="Manage">
      <div className="flex flex-col justify-center items-center md-32 lg:md-32">
        <div className="bg-white ml-5 px-5 py-3 rounded-md space-x-3 space-y-3">
          <div className="flex justify-center items-center">
            <h1 className="font-bold text-black text-xl">Manage Server</h1>
          </div>
          <Link href={`/manage/${id}/general`} passHref>
            <button className="px-3 py-2 bg-main-300 text-light-200 rounded-md font-semibold hover:bg-main-400">
              General Settings
            </button>
          </Link>
